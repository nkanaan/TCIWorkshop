...
7. In the form, Copy the below sample json in the **Provide Sample Data** field and click on the **Generate schema** button. Give the created schema a name, for ex quotation_request.
	```json
    {
    ...
    ```
	![Edit Succes response](images/edit_request_body.png)
