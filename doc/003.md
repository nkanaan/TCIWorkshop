...
2. In the following form, select the **Quotation** for the API Definition, select **Swagger** for the format of the document you are uploading, and choose the `SalesOrder-Mashery.json` from the filesystem as the JSON file to upload.
